...
public class GlobalCacheSdk {
     ...
     * @return 每个节点清理结果
     * @throws ThreadPoolRuntimeException 运行时线程池故障抛出此异常
     * @see com.example.globalcachesdk.entity.GeneralOperationResult
     */
    public static HashMap<String, CommandExecuteResult> cleanNodesZookeeper(ArrayList<String> hosts) throws ThreadPoolRuntimeException {
        SshSessionPool sshSessionPool = SshSessionPool.getInstance();

        return  sshSessionPool.execute(hosts, SupportedCommand.ZOOKEEPER_CLEAN);
    }
     ...
     * @see com.example.globalcachesdk.entity.GeneralOperationResult
     */
    public static HashMap<String, CommandExecuteResult> initNodesBdm(ArrayList<String> hosts) throws ThreadPoolRuntimeException {
        SshSessionPool sshSessionPool = SshSessionPool.getInstance();

        return  sshSessionPool.execute(hosts, SupportedCommand.BDM_INIT);
    }

    /**
     * 管理gc状态
     * 支持的命令见gc_service_control.sh
     *
     * @param hosts 需要获取主机IP列表
     * @return 每个节点执行结果
     * @throws ThreadPoolRuntimeException 运行时线程池故障抛出此异常
     * @see com.example.globalcachesdk.entity.GeneralOperationResult
     */
    public static HashMap<String, CommandExecuteResult> nodesGcServiceControl(ArrayList<String> hosts, String parameter) throws ThreadPoolRuntimeException {
        SshSessionPool sshSessionPool = SshSessionPool.getInstance();

        return  sshSessionPool.execute(hosts, SupportedCommand.GC_SERVICE_CONTROL,parameter);
    }
     ...
     * @see com.example.globalcachesdk.entity.GeneralOperationResult
     */
    public static HashMap<String, CommandExecuteResult> startNodesGcServiceControl(ArrayList<String> hosts) throws ThreadPoolRuntimeException {
        return  nodesGcServiceControl(hosts,"start");
    }
     ...
     * @see com.example.globalcachesdk.entity.GeneralOperationResult
     */
    public static HashMap<String, CommandExecuteResult> stopNodesGcServiceControl(ArrayList<String> hosts) throws ThreadPoolRuntimeException {
        return  nodesGcServiceControl(hosts,"stop");
    }
}
